...
public class AddAnUser extends javax.swing.JFrame {
    ...
    public AddAnUser(MannageUsers parent) {
        this.parent = parent;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("FORM ADD AN USER");
    ...
    private void jBut_SignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBut_SignUpActionPerformed
        ...
        if(radio_admin.isSelected()){
            boolean check = AdminController.addAnAdmin(new Admin(0, full_name, dateofbirth, phonenum, user_name,"12345" ));
            if(!check){
