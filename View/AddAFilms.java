 ...
 * @author nguye
 */
public class AddAFilms extends javax.swing.JFrame {
    ImageIcon icon = null;
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        try {
                    ...
                    boolean res = FilmDAO.addAFilm(new Film(-1,strtitle,strdescription,dur,favgenre, "", strcast, strdate, "Vietnamese",linkImg));
                    if(res)
                        mess.setText("Added successfully");
                    else
                        mess.setText("Added fail");
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAFilms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
